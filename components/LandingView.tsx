            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <div className="relative group">
                <a 
                  ...
                  className="text-sm font-bold hover:text-orange-400 transition-colors uppercase tracking-wide flex items-center gap-1 cursor-pointer"
                >
                  <span className="text-orange-500">AIBC</span> <span className="text-white">STREAM</span>
                  <svg className="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                  </svg>
                </a>
                
                {/* Large Dropdown Modal - Matches Design */}
                <div className="absolute top-full left-1/2 -translate-x-1/2 mt-6 w-[480px] bg-[#0A0A0A] border border-white/10 rounded-2xl p-4 shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                  <div className="space-y-3">
                    {/* AI Streaming Channels Card */}
                    <a 
                      href="https://aibroadcasting.xyz"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="block p-5 bg-white/[0.02] border border-white/10 rounded-xl hover:border-white/20 hover:bg-white/[0.04] transition-all group/item cursor-pointer"
                    >
                      <div className="flex items-start gap-4">
                        {/* Purple Icon with Video Camera */}
                        <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-purple-600 to-purple-800 flex items-center justify-center flex-shrink-0 border border-purple-500/20">
                          <Video className="w-7 h-7 text-white" strokeWidth={2} />
                        </div>
                        <div className="flex-1 pt-1">
                          <h3 className="text-base font-bold text-white mb-1 group-hover/item:text-orange-400 transition-colors">AI Streaming Channels</h3>
                          <p className="text-sm text-white/50">Real-time video synthesis</p>
                        </div>
                      </div>
                    </a>
                    ...
                    {/* CopyStream Card */}
                    <a 
                      href="https://copystream.ai"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="block p-5 bg-white/[0.02] border border-white/10 rounded-xl hover:border-white/20 hover:bg-white/[0.04] transition-all group/item cursor-pointer"
                    >
                      <div className="flex items-start gap-4">
                        {/* Blue Icon with Document */}
                        <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-blue-600 to-blue-800 flex items-center justify-center flex-shrink-0 border border-blue-500/20">
                          <FileText className="w-7 h-7 text-blue-200" strokeWidth={2} />
                        </div>
                        <div className="flex-1 pt-1">
                          <h3 className="text-base font-bold text-white mb-1 group-hover/item:text-orange-400 transition-colors">CopyStream</h3>
                          <p className="text-sm text-white/50">AI content generation</p>
                        </div>
                      </div>
                    </a>
                  </div>
