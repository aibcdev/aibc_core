 ...
 */
import { z } from 'zod';
import type { BrandOverlay, BrandContext, StyleConstraints, ComplianceRules, ToneAdjustments } from '../../shared/types.js';
...
export function validateBrandOverlay(data: unknown): BrandOverlay {
    return BrandOverlaySchema.parse(data) as BrandOverlay;
}

export function isValidBrandOverlay(data: unknown): data is BrandOverlay {
...
export const INDUSTRY_PRESETS = {
    b2b_saas: {
        ...
        style_constraints: { sentence_length: 'medium' as const, use_bullets: true, cta_style: 'soft_authoritative' as const },
    ...
    fintech: {
        ...
        style_constraints: { sentence_length: 'medium' as const, use_bullets: true, cta_style: 'subtle' as const },
        compliance_rules: { no_false_claims: true, no_financial_promises: true },
    ...
    consumer_brand: {
        ...
        style_constraints: { sentence_length: 'short' as const, use_bullets: false, cta_style: 'direct' as const },
...
export function createBrandOverlayFromPreset(
