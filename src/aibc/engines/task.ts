...
class GeminiClient {
    ...
    private generateMockResponse(request: GeminiRequest): string {
...
export class TaskEngine {
     ...
     */
    private calculateMaxTokens(task: TaskDefinition): number {
     ...
     */
    private parseOutputSections(content: string, requiredOutputs: string[]): Record<string, string> {
...
export function createTaskEngine(options?: { apiKey?: string; model?: string }): TaskEngine {
