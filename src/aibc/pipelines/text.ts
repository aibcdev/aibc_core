 ...
 */
import type { TextOutput, CharacterSnapshot, BrandOverlay, TaskDefinition } from '../../shared/types.js';
...
export class TextPipeline {
     ...
     */
    format(output: TextOutput, options: FormatOptions = { format: 'markdown', includeMetadata: false }): string {
     ...
     */
    private formatMetadata(output: TextOutput): string {
