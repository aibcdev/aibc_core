 ...
 */
import { z } from 'zod';
import type { CharacterSnapshot, PersonaCore, VoiceProfile, LicenseTerms, SpeechTraits } from '../../shared/types.js';
...
export function validateCharacterSnapshot(data: unknown): CharacterSnapshot {
    return CharacterSnapshotSchema.parse(data) as CharacterSnapshot;
}

export function isValidCharacterSnapshot(data: unknown): data is CharacterSnapshot {
