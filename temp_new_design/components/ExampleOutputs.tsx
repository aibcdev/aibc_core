...
import { ArrowRight, X, Play, Volume2, Share2, TrendingUp, Search, Globe, ShieldCheck, Sparkles, Check, Zap, Target, Activity, Hash, MousePointer2, AlertTriangle, Fingerprint } from 'lucide-react';
