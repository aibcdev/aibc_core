      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="relative z-10">
                <div className="inline-flex items-center gap-2 text-xs font-semibold text-emerald-400 border border-emerald-500/20 bg-emerald-500/5 rounded-full px-3 py-1 mb-8 tracking-wider uppercase">
            ...
            <div className="relative">
                 ...
                 <div className="relative rounded-[2.5rem] overflow-hidden border border-zinc-800 bg-zinc-900 aspect-[9/16] md:aspect-[4/5] shadow-2xl group cursor-pointer">
                    ...
                    {/* Floating Badge */}
                    <div className="absolute top-8 right-8 px-4 py-2 bg-black/60 backdrop-blur-md rounded-full border border-white/10 text-xs font-medium text-white uppercase tracking-wider">
                        1080p HQ
                    </div>
                 </div>
            </div>
