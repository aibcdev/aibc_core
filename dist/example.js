...
import { 
// Agentwood
initializeDefaultCharacters, listAvailableArchetypes, createCharacterFromArchetype, 
// AIBC
createBrandOverlayFromPreset, createTaskFromTemplate, createTaskEngine, createAudioPipeline, textPipeline, } from './index.js';
async function main() {
    ...
    const audioResult = await audioPipeline.generateAudio(result.output, character.voice_profile);
